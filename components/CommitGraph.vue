      ...
      >
        <svg data-testid="lang-items" x="25">
          ...
          <rect
            mask="url(#rect-mask)"
            data-testid="lang-progress"
            x="243.51000000000002"
            y="0"
            width="16.490000000000002"
            height="8"
            fill="#563d7c"
          />
...
.right {
  ...
  .stagger {
    opacity: 0;
    animation: fadeInAnimation1 0.3s ease-in-out forwards;
  }
  .rank-text {
    font: 800 24px "Segoe UI", Ubuntu, Sans-Serif;
    fill: #434d58;
    animation: scaleInAnimation1 0.3s ease-in-out forwards;
  }
  ...
  @keyframes rankAnimation {
    ...
    to {
      stroke-dashoffset: 191.84703157102376;
    }
  }

  /* Animations */
  @keyframes scaleInAnimation1 {
    from {
      transform: translate(-5px, 5px) scale(0);
    }
    to {
